...
import { Lock, DollarSign, Gift, Award } from "lucide-react";
...
export function ValueBreakdown({
  ...
  const { card, annualFee, creditsValue, credits, perks, perksValue, rewardsValue, totalValue } = analysis;
  ...
  return (
    <div className="px-4 sm:px-5 py-4 space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="rounded-xl bg-muted/30 p-3">
          <p className="text-[10px] text-muted-foreground uppercase tracking-wide mb-1">Perks</p>
          <p className="text-base font-bold text-emerald-500">+{formatCurrency(perksValue)}</p>
        </div>
      </div>
