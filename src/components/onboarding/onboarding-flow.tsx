      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="grid grid-cols-2 gap-2.5 sm:gap-3 w-full">
          {[
            ...
            { label: "Annual Fee Check", description: "See if your annual fee is worth it", icon: <Scale className="w-6 h-6 text-muted-foreground" />, href: "/keep-or-cancel" },
            { label: "Card Fee Calculator", description: "Reveal a premium card's real cost", icon: <Calculator className="w-6 h-6 text-muted-foreground" />, href: "/calculator" },
