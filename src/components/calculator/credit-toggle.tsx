  ...
  return (
    <>
      ...
      >
        ...
        <div className="shrink-0 text-right min-w-[84px]">
          <div
            className={cn(
              "text-2xs uppercase tracking-[0.14em] font-semibold whitespace-nowrap",
              label.tone === "full" && "text-success",
          ...
          {applied > 0 && (
            <div className="text-xs font-mono tabular-nums text-success mt-0.5 whitespace-nowrap">
