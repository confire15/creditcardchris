...
export default async function PublicProfilePage({
  ...
  const badges = [
    cardsCount >= 5 && { label: "Power User", icon: Star, color: "text-warning", bg: "bg-warning/10 border-warning/20" },
    ...
    totalRewards >= 500000 && { label: "500k+ points", icon: Trophy, color: "text-warning", bg: "bg-warning/10 border-warning/20" },
    totalRewards >= 100000 && totalRewards < 500000 && { label: "100k+ points earned", icon: Sparkles, color: "text-warning", bg: "bg-warning/10 border-warning/20" },
