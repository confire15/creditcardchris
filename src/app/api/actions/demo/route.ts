  ...
  const rows = [
    {
      ...
      proposed_action: { type: "navigate", href: "/wallet?tab=credits-benefits", label: "Review benefit" },
    ...
    },
    {
      ...
      proposed_action: { type: "navigate", href: "/wallet?tab=challenges", label: "Build spend plan" },
