...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="hidden lg:flex w-[480px] xl:w-[540px] flex-col justify-between bg-card border-l border-border p-12 relative overflow-hidden">
        {/* Background orb */}
            ...
            {[
              {
                ...
                desc: "Track 59+ card templates or add your own.",
              },
              {
                icon: TrendingUp,
